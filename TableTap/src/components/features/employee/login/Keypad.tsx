...
function Keypad({ initialValue = "", onSubmit }: Props) {
  ...
  return (
    <div className="d-flex flex-column align-items-center mt-4">
      {/* display box */}
      <div
        className="form-control text-end mb-4 mt-4 fs-4 bg-white shadow-sm"
      ...
      >
        {keys.map((key) => (
          <button
            key={key}
            className="btn bg-white fw-semibold rounded-circle fs-2 shadow-sm d-flex align-items-center justify-content-center"
