import { useOrganizationName } from "../../../shared/hooks/useOrganizationName";
...
const Navbar = ({ heading, onToggleSidebar }: Props) => {
  const { organizationName, loading } = useOrganizationName();
    ...
    >
      <div className="container-fluid d-flex justify-content-between align-items-center">
        <div className="d-flex align-items-center">
          ...
          <span className="navbar-brand mb-0 h1 fs-4">
            {heading}
